package com.acme.testing.junit.parametized;
...
public class CalculateParametizedTest {

	private int expected;
	private int param1;
	private int param2;

	public CalculateParametizedTest(int expectedResult, int firstNumber, int secondNumber) {
