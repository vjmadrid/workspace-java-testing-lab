...
This project represents a collection of examples to explain the use and configuration of **ArchUnit**

* Check architecture Java
* Formalising code architecture -> "conventions"
* Check dependencies between packages , classes, layers, ...
